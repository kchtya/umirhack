      ...
      <nav class="nav">
        ...
        <div class="nav-right">
          <div class="auth-buttons">
            ...
            <button class="auth-btn register-btn adaptive-btn" @click="goToRegister">Регистрация</button>
          </div>
          <button 
            class="theme-toggle" 
          ...
          <div class="auth-card-wrapper">
            <div class="auth-card">
              ...
              <form @submit.prevent="handleLogin" class="auth-form">
                ...
                <!-- ИСПРАВЛЕНО: Кнопка с адаптивным цветом -->
                <button type="submit" class="auth-submit-btn adaptive-btn">Войти</button>
              </form>
              <p class="auth-link">
